...
def get_qa_chain(vectorstore):
    ...
    # PROMPT PERSONALIZADO COM AS SUAS ESPECIFICAÇÕES
...
Include additional information that may help to explain the topic, even if not directly asked, and always cite relevant articles.
...
Answer:"""
    ...
    # Usando RetrievalQA em vez de ConversationalRetrievalChain para evitar memória
...
def handle_userinput(user_question):
    ...
    try:
        ...
        # Mostrar fontes utilizadas para debug
